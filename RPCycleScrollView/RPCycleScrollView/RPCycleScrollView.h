...
@class RPCycleScrollView;
@protocol RPCycleScrollViewDelegate <NSObject>
/** 点击图片回调 */
- (void)cycleScrollView:(RPCycleScrollView *)cycleScrollView didSelectItemAtIndex:(NSInteger)index;
@end


@interface RPCycleScrollView : UIView
//*是否无线循环，默认yes
...
//代理方法
@property (nonatomic,weak) id<RPCycleScrollViewDelegate> delegate;
