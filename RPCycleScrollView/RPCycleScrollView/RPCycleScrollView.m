...
#import "RPCycleScrollViewCell.h"
#import "RPCycleScrollViewFlowLayout.h"
#define kScreenWidth  [UIScreen mainScreen].bounds.size.width

@interface RPCycleScrollView()<UICollectionViewDataSource,UICollectionViewDelegate>
@property (nonatomic,strong) UIImageView *backgroundImageView;
@property (nonatomic,strong) RPCycleScrollViewFlowLayout *flowLayout;
...
@implementation RPCycleScrollView
{
    float _oldPoint;
...
{
    RPCycleScrollView *cycleScrollView = [[RPCycleScrollView alloc]initWithFrame:frame];
...
{
    RPCycleScrollViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellID forIndexPath:indexPath];
...
-(UICollectionView *)collectionView
{
    if(_collectionView == nil)
    {
        ...
        //注册cell
        [_collectionView registerClass:[RPCycleScrollViewCell class] forCellWithReuseIdentifier:cellID];
...
-(RPCycleScrollViewFlowLayout *)flowLayout
{
    if(_flowLayout == nil)
    {
        _flowLayout = [[RPCycleScrollViewFlowLayout alloc]init];
